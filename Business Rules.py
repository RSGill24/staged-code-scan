...
python "$(System.DefaultWorkingDirectory)/_Landing a file in EDL in less than 24 hours/scripts/integration_readiness.py" \
  --file "/home/vsts/work/_temp/downloads/$(BLOB_FILE_NAME)" --domain Claims